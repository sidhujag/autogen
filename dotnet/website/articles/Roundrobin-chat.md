...
> [!NOTE]
> Complete code can be found in [Example11_Sequential_GroupChat_Example](https://github.com/superdapp/superdappstudio/blob/dotnet/dotnet/sample/AutoGen.BasicSamples/Example11_Sequential_GroupChat_Example.cs);
