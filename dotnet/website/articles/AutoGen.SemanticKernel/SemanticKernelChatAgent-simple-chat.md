...
> [!NOTE]
> You can find the complete sample code [here](https://github.com/superdapp/superdappstudio/blob/main/dotnet/sample/AutoGen.SemanticKernel.Sample/Create_Semantic_Kernel_Chat_Agent.cs).
