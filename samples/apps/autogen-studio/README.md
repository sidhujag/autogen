...
Code for SuperDapp Studio is on GitHub at [sidhujag/autogen](https://github.com/sidhujag/autogen/tree/main/samples/apps/autogen-studio)
...
> [!WARNING]
> SuperDapp Studio is currently under active development and we are iterating quickly. Kindly consider that we may introduce breaking changes in the releases during the upcoming weeks, and also the `README` might be outdated. We'll update the `README` as soon as we stabilize the API.

### Capabilities / Roadmap

Some of the capabilities supported by the app frontend include the following (some of which are not part of AutoGen but only SuperDapp):
...
- [x] Support for more complex agent workflows (e.g. `GroupChat` workflows). Nested groupchat support.
- [x] Persistance of objects across communication sessions.
- [x] Dynamic initialization code for agents (init_code). Load agents dynamically through classes/objects instead of just UserProxy/Assistant Agent instatiation.
- [x] Skill examples field for better skill usage and steering.
- [x] Code assistance (through aider), service and skill built-in.
- [x] Zapier service and skill built-in for external API connections.
- [x] Web surfer uses Google for real-time information and Bing for other web searches.
...
SuperDapp Studio proposes some high-level concepts.
...
- Review the overall SuperDapp project [contribution guide](https://github.com/sidhujag/autogen?tab=readme-ov-file#contributing)
- Please review the SuperDapp Studio [roadmap](https://github.com/microsoft/autogen/issues/737) to get a sense of the current priorities for the project. Help is appreciated especially with Studio issues tagged with `help-wanted`
- Please initiate a discussion on the roadmap issue or a new issue to discuss your proposed contribution.
- Please review the autogenstudio dev branch here [dev branch](https://github.com/sidhujag/autogen/tree/autogenstudio) and use as a base for your contribution. This way, your contribution will be aligned with the latest changes in the SuperDapp Studio project.
