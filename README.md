...
> [!NOTE]
> *Note for contributors and users*</b>: [SuperDappAI/superdappstudio](https://aka.ms/autogen-gh) is the original repository of AutoGen project and it is under active development and maintenance under MIT license. We welcome contributions from developers and organizations worldwide. Our goal is to foster a collaborative and inclusive community where diverse perspectives and expertise can drive innovation and enhance the project's capabilities. We acknowledge the invaluable contributions from our existing contributors, as listed in [contributors.md](./CONTRIBUTORS.md). Whether you are an individual contributor or represent an organization, we invite you to join us in shaping the future of this project. For further information please also see [Microsoft open-source contributing guidelines](https://github.com/SuperDappAI/superdappstudio?tab=readme-ov-file#contributing).
>
> -_Maintainers (Sept 6th, 2024)_


![AutoGen Overview](https://github.com/SuperDappAI/superdappstudio/blob/0.2/website/static/img/autogen_agentchat.png)
...
<!-- :fire: Nov 24: pyautogen [v0.2](https://github.com/SuperDappAI/superdappstudio/releases/tag/v0.2.0) is released with many updates and new features compared to v0.1.1. It switches to using openai-python v1. Please read the [migration guide](https://microsoft.github.io/autogen/docs/Installation#python). -->
...
1. Click below to use the GitHub Codespace
    ...
    [![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/SuperDappAI/superdappstudio?quickstart=1)
...
<!-- Each of the [`notebook examples`](https://github.com/SuperDappAI/superdappstudio/tree/main/notebook) may require a specific option to be installed. -->
...
For [example](https://github.com/SuperDappAI/superdappstudio/blob/0.2/test/twoagent.py),
...
![Agent Chat Example](https://github.com/SuperDappAI/superdappstudio/blob/0.2/website/static/img/chat_example.png)

Alternatively, the [sample code](https://github.com/SuperDappAI/superdappstudio/blob/0.2/samples/simple_chat.py) here allows a user to chat with an AutoGen agent in ChatGPT style.
...
- [Research](https://microsoft.github.io/autogen/docs/Research), [blogposts](https://microsoft.github.io/autogen/blog) around AutoGen, and [Transparency FAQs](https://github.com/SuperDappAI/superdappstudio/blob/0.2/TRANSPARENCY_FAQS.md)
...
## Contributors Wall
<a href="https://github.com/SuperDappAI/superdappstudio/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=SuperDappAI/superdappstudio&max=204" />
</a>
