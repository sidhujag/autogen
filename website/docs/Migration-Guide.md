...
```
Checkout [Logging documentation](https://microsoft.github.io/autogen/docs/Use-Cases/enhanced_inference#logging) and [Logging example notebook](https://github.com/superdapp/superdappstudio/blob/0.2/notebook/agentchat_logging.ipynb) to learn more.
