...
For example, when developing in [GitHub codespace](https://codespaces.new/SuperDappAI/superdappstudio?quickstart=1),
...
(from [issue #251](https://github.com/SuperDappAI/superdappstudio/issues/251))
...
(from [issue #478](https://github.com/SuperDappAI/superdappstudio/issues/478))
