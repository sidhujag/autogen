...
For example, when developing in [GitHub codespace](https://codespaces.new/superdapp/superdappstudio?quickstart=1),
...
(from [issue #251](https://github.com/superdapp/superdappstudio/issues/251))
...
(from [issue #478](https://github.com/superdapp/superdappstudio/issues/478))
