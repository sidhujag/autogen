...
## TL;DR
OpenAI assistants are now integrated into AutoGen via [`GPTAssistantAgent`](https://github.com/superdapp/superdappstudio/blob/0.2/autogen/agentchat/contrib/gpt_assistant_agent.py).
...
* [Basic example](https://github.com/superdapp/superdappstudio/blob/0.2/notebook/agentchat_oai_assistant_twoagents_basic.ipynb)
* [Code interpreter](https://github.com/superdapp/superdappstudio/blob/0.2/notebook/agentchat_oai_code_interpreter.ipynb)
* [Function calls](https://github.com/superdapp/superdappstudio/blob/0.2/notebook/agentchat_oai_assistant_function_call.ipynb)
...
Checkout more examples [here](https://github.com/superdapp/superdappstudio/tree/main/notebook).
