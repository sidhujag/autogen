...
- See the [AutoGenBench README](https://github.com/superdapp/superdappstudio/blob/0.2/samples/tools/autogenbench/README.md) for information on installation and running benchmarks.
- See the [AutoGenBench CONTRIBUTING guide](https://github.com/superdapp/superdappstudio/blob/0.2/samples/tools/autogenbench/CONTRIBUTING.md) for information on developing or contributing benchmark datasets.
...
Finally, complete execution traces and logs can be found in the `Results` folder. See the [AutoGenBench README](https://github.com/superdapp/superdappstudio/blob/0.2/samples/tools/autogenbench/README.md) for more details about command-line options and output formats. Each of these commands also offers extensive in-line help via:
