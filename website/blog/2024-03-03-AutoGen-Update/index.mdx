...
- new features like stateful code execution, [tool decorators](/docs/Use-Cases/agent_chat#tool-calling), [long context handling](https://github.com/SuperDappAI/superdappstudio/blob/0.2/notebook/agentchat_capability_long_context_handling.ipynb), [web agents](https://github.com/SuperDappAI/superdappstudio/blob/0.2/notebook/agentchat_surfer.ipynb).
- integration examples like using [guidance](https://github.com/SuperDappAI/superdappstudio/blob/0.2/notebook/agentchat_guidance.ipynb) to generate structured response.
