---
title: "Superdapp Studio: Interactively Explore Multi-Agent Workflows"
authors:
  - victordibia
  - gagb
  - samershi
...
![Superdapp Studio Playground View: Solving a task with multiple agents that generate a pdf document with images.](img/SUPERDAPPSTUDIO_home.png)

<p align="center">
  <em>
    Superdapp Studio: Solving a task with multiple agents that generate a pdf
...
To help you rapidly prototype multi-agent solutions for your tasks, we are introducing Superdapp Studio, an interface powered by [AutoGen](https://github.com/SuperDappAI/superdappstudio/tree/main/autogen). It allows you to:
...
See the official Superdapp Studio documentation [here](https://microsoft.github.io/autogen/docs/superdapp-studio/getting-started) for more details.

Superdapp Studio is open source [code here](https://github.com/SuperDappAI/superdappstudio/tree/main/samples/apps/superdapp-studio), and can be installed via pip. Give it a try!
...
The accelerating pace of technology has ushered us into an era where digital assistants (or agents) are becoming integral to our lives. [AutoGen](https://github.com/SuperDappAI/superdappstudio/tree/main/autogen) has emerged as a leading framework for orchestrating the power of agents. In the spirit of expanding this frontier and democratizing this capability, we are thrilled to introduce a new user-friendly interface: **Superdapp Studio**.

With Superdapp Studio, users can rapidly create, manage, and interact with agents that can learn, adapt, and collaborate. As we release this interface into the open-source community, our ambition is not only to enhance productivity but to inspire a level of personalized interaction between humans and agents.
...
## Getting Started with Superdapp Studio

The following guide will help you get Superdapp Studio up and running on your system.
...
2. **Install from Source**
   ...
   For Windows users, to build the frontend, you may need alternative commands provided in the [Superdapp Studio readme](https://github.com/SuperDappAI/superdappstudio/tree/main/samples/apps/superdapp-studio).
...
## What Can You Do with Superdapp Studio?

The Superdapp Studio UI is organized into 3 high level sections - **Build**, **Playground**, and **Gallery**.

### Build

![Specify Agents.](img/SUPERDAPPSTUDIO_config.png)

This section focuses on defining the properties of agents and agent workflows. It includes the following concepts:

**Skills**: Skills are functions (e.g., Python functions) that describe how to solve a task. In general, a good skill has a descriptive name (e.g. `generate_images`), extensive docstrings and good defaults (e.g., writing out files to disk for persistence and reuse). You can add new skills to Superdapp Studio via the provided UI. At inference time, these skills are made available to the assistant agent as they address your tasks.

![View and add skills.](img/SUPERDAPPSTUDIO_skills.png)

<p align="center">
  <em>
    Superdapp Studio Build View: View, add or edit skills that an agent can
    leverage in addressing tasks.
  </em>
</p>

**Agents**: This provides an interface to declaratively specify properties for an AutoGen agent (mirrors most of the members of a base [AutoGen conversable agent](https://github.com/SuperDappAI/superdappstudio/blob/0.2/autogen/agentchat/conversable_agent.py) class).
...
<p align="center">
  <em>
    Superdapp Studio Playground View: Agents collaborate, use available skills
...
Superdapp Studio comes with 3 example skills: `fetch_profile`, `find_papers`, `generate_images`. Please feel free to review the repo to learn more about how they work.

## The Superdapp Studio API

While Superdapp Studio is a web interface, it is powered by an underlying python API that is reusable and modular. Importantly, we have implemented an API where agent workflows can be declaratively specified (in JSON), loaded and run. An example of the current API is shown below. Please consult the [Superdapp Studio repo](https://github.com/SuperDappAI/superdappstudio/tree/main/samples/apps/superdapp-studio) for more details.

```python
import json
from superdappstudio import AutoGenWorkFlowManager, AgentWorkFlowConfig
...
As we continue to develop and refine Superdapp Studio, the road map below outlines an array of enhancements and new features planned for future releases. Here's what users can look forward to:
...
- **Community Features**: Facilitation of sharing and collaboration within Superdapp Studio user community is a key goal. We're exploring options for sharing sessions and results more easily among users and contributing to a shared repository of skills, agents, and agent workflows.
...
- If you are modifying Superdapp Studio in vscode, it has its own devcontainer to simplify dev work. See instructions in `.devcontainer/README.md` on how to use it.
...
A: To reset your conversation history, you can delete the `database.sqlite` file. If you need to clear user-specific data, remove the relevant `superdappstudio/web/files/user/<user_id_md5hash>` folder.
...
**Q: Where can I find documentation and support for Superdapp Studio?**
A: We are constantly working to improve Superdapp Studio. For the latest updates, please refer to the [Superdapp Studio Readme](https://github.com/SuperDappAI/superdappstudio/tree/main/samples/apps/superdapp-studio). For additional support, please open an issue on [GitHub](https://github.com/SuperDappAI/superdappstudio) or ask questions on [Discord](https://aka.ms/autogen-dc).
