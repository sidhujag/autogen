...
See the official Superdapp Studio documentation [here](https://microsoft.github.io/autogen/docs/autogen-studio/getting-started) for more details.

Superdapp Studio is open source [code here](https://github.com/SuperDappAI/superdappstudio/tree/main/samples/apps/autogen-studio), and can be installed via pip. Give it a try!
...
2. **Install from Source**
   ...
   For Windows users, to build the frontend, you may need alternative commands provided in the [Superdapp Studio readme](https://github.com/SuperDappAI/superdappstudio/tree/main/samples/apps/autogen-studio).
