...
Next, the critic is given successful and failed examples of the task execution; then, it is able to return a list of criteria (Fig. 1). For reference, use the [following notebook](https://github.com/SuperDappAI/superdappstudio/blob/0.2/notebook/agenteval_cq_math.ipynb).
