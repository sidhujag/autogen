...
by AutoGen that's intended to assist AutoGen Devs. See [`samples/apps/auto-anny`](https://github.com/superdapp/superdappstudio/tree/main/samples/apps/auto-anny) for details.
...
To use Anny, please follow instructions in [`samples/apps/auto-anny`](https://github.com/superdapp/superdappstudio/tree/main/samples/apps/auto-anny).
