...
As the first step, we are opening a [pull request](https://github.com/SuperDappAI/superdappstudio/pull/3600) into the main branch with the
...
- **AgentChat** - a task-driven, high-level API built with core, including group
  ...
  to AutoGen [0.2](https://github.com/SuperDappAI/superdappstudio/tree/0.2) and will be the easiest API to migrate to.
...
AutoGen [0.2](https://github.com/SuperDappAI/superdappstudio/tree/0.2) is still available, developed and maintained out of the [0.2 branch](https://github.com/SuperDappAI/superdappstudio/tree/0.2).
For everyone looking for a stable version, we recommend continuing to use [0.2](https://github.com/SuperDappAI/superdappstudio/tree/0.2)
...
Discussion](https://github.com/SuperDappAI/superdappstudio/discussions) as the official
