...
install_requires = [
    ...
    "termcolor",
    "flaml",
    # numpy is installed by flaml, but we want to pin the version to below 2.x (see https://github.com/SuperDappAI/superdappstudio/issues/1960)
    "numpy>=1.17.0,<2",
    "python-dotenv",
    "tiktoken",
...
setuptools.setup(
    ...
    url="https://github.com/SuperDappAI/superdappstudio",
